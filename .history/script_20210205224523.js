...
var SmanualNav = function(smanual) {
    servSlides.forEach((serviceSlide) => {
            ...
            servbox.forEach((servelide) => {
                servelide.classList.remove('service-active');
            });
        ...
        servSlides[smanual].classList.add('service-active'); linkbuttons[smanual].classList.add('service-active'); servbox[smanual].classList.add('service-active');
    });
