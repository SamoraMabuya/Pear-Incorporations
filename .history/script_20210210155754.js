...
var dmanualNav = function(dmanual) {
    slides.forEach((slide) => {
    ...
    servSlides.forEach((serviceSlide) => {
        ...
        slides[dmanual].classList.add('active-slide');
        servSlides[dmanual].classList.add('service-active');
        mobileSlides[dmanual].classList.add('service-active');
        stickybtn[dmanual].classList.add('activelink');
    });
...
//         if (revealtop < windowheight - revealpoint) {
//             reveals[i].classList.add('section');
//         } else {
//             reveals[i].classList.remove('section');
