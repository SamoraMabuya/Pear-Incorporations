...
// Get the navbar
var aboutNav = document.getElementById(".about-nav-wrapper");

// Get the offset position of the navbar
var aboutStickyheader = aboutNav.offsetTop;

// Add the sticky class to the navbar when you reach its scroll position. Remove "sticky" when you leave the scroll position
function myFunction() {
    if (window.pageYOffset >= aboutStickyheader) {
        aboutNav.classList.add("stickyabout")
        alert("working");
    } else {
        aboutNav.classList.remove("stickyabout");
        alert("working");
