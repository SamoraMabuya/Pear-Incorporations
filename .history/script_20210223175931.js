...
function responsiveMenu() {
    let NavMenu = document.querySelector(".Nabmenu");
    const menuBtn = document.querySelector(".mobileNavMenu");
    let cancelIcon = document.querySelector(".close");
    menuIcon.onclick = () => {
...
//         aboutsidenav.classList.add("sticky")
//     } else {
//         aboutsidenav.classList.remove("sticky");
//     }
// }