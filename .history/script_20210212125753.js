...
function show() {
    ...
    // var showsidenav = document.querySelectorAll('.sidenav');
    ...
    for (var i = 0; i < shows.length; i++) {
        ...
        if (showtop < wheight - showpoint) {
            ...
            // showsidenav[i].classList.add('elements');

        } else {
            shows[i].classList.remove('element');
            // showsidenav[i].classList.remove('elements');
...
windows.addEventListener('scroll', showsidenav);

function showsidenav() {
    var showsidenav = document.querySelectorAll('.sidenav');

    for (var i = 0; i < showsidenav.length; i++) {

        var sidenavheight = windows.innerHeight;
        var showsidetop = showsidenav[i].getBoundingClientRect().top;
        var showsidepoint = 100;

        if (showsidetop < sidenavheight - showsidepoint) {
            showsidenav[i].classList.add('elements');
