...
var navbtn = document.querySelectorAll('.services-link');

var servicemanual = function(servicemanual) {
    servbox.forEach((servicebox) => {
        servicebox.classList.remove('service-active');


        navbtn.forEach((linkbtn) => {
            linkbtn.classList.remove('service-active');
        ...
        servicebox[servicemanual].classList.add('service-active');
        navbtn[servicemanual].classList.add('service-active');
    });

}
navbtn.forEach((linkbtn, i) => {
    linkbtn.addEventListener("click", () => {
        servicemanual(i);
        thisSlide = i;
    });
