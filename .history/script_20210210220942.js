...
// var serviceSlides = document.querySelectorAll('.service-box');
...
//     stickybtn.forEach((sbtn) => {
//         sbtn.classList.remove('active-link');
//     });

//     stickybtn[dmanual].classList.add('active-link');
// }


// stickybtn.forEach((sbtn, i) => {
