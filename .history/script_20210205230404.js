...
var servSlides = document.querySelectorAll('.service-box, .mobiledev-box');
...
var SmanualNav = function(smanual) {
        servSlides.forEach((serviceSlide, ) => {
                ...
                servSlides[smanual].classList.add('service-active'); linkbuttons[smanual].classList.add('service-active');
